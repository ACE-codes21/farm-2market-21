...
import { User as UserIcon, Settings, Shield, Info, LogOut, Heart, CreditCard, HelpCircle, Bell } from 'lucide-react';
...
export const UserMenuItems: React.FC<UserMenuItemsProps> = ({
  ...
  return <>
      ...
      {isVendor ? <VendorProfileModal isOpen={isProfileModalOpen} onClose={() => setIsProfileModalOpen(false)} /> : <BuyerProfileModal isOpen={isProfileModalOpen} onClose={() => setIsProfileModalOpen(false)} />}
    </>;
};
