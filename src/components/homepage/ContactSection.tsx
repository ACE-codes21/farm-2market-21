...
export const ContactSection: React.FC = () => {
  ...
  return (
    <footer ref={ref} id="contact-footer" className="relative py-16 px-4 bg-gradient-to-b from-black/80 via-neutral-900/95 to-black border-t border-white/10">
      <motion.div
        className="max-w-4xl mx-auto flex flex-col md:flex-row md:items-center md:justify-between"
        ...
        <div className="mb-10 md:mb-0">
          ...
          <div className="flex gap-8 text-lg text-gray-300">
            ...
            <div className="flex items-center gap-2">
              ...
              <a href="tel:+919876543210" className="hover:text-orange-200 underline">+91 98765 43210</a>
            </div>
          </div>
        </div>
        {/* Socials */}
