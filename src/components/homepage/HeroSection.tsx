  ...
  return (
    <>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 pb-24">
        <div className="text-center max-w-5xl mx-auto opacity-0 animate-fade-in">
      ...
      <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 z-20">
        <Button 
          ...
          variant="ghost" 
          className="text-green-400/80 hover:text-green-400 hover:bg-green-400/10 hover:shadow-[0_0_15px_rgba(34,197,94,0.3)] transition-all duration-300 border border-green-400/20 mb-4"
        >
          Browse Market Demo
        </Button>
      </div>
