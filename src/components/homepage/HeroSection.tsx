      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        <div className="text-center max-w-5xl mx-auto animate-fade-in">
          ...
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold mb-8 leading-tight">
            <span className="text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.3)]">Fresh From the</span>
            <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            <Button 
              ...
              size="lg" 
              className="bg-green-500 hover:bg-green-400 text-black font-bold shadow-[0_0_30px_rgba(34,197,94,0.5)] hover:shadow-[0_0_40px_rgba(34,197,94,0.8)] transform hover:scale-105 transition-all duration-300 px-16 py-8 text-2xl rounded-2xl group min-w-[280px] border-2 border-green-400"
            >
            ...
            <Button 
              ...
              size="lg" 
              variant="outline"
              className="border-2 border-green-400 text-green-400 hover:bg-green-400/10 hover:text-green-300 shadow-[0_0_20px_rgba(34,197,94,0.3)] hover:shadow-[0_0_30px_rgba(34,197,94,0.6)] transform hover:scale-105 transition-all duration-300 px-16 py-8 text-2xl font-bold rounded-2xl group min-w-[280px] backdrop-blur-sm"
            >
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 bg-gradient-to-t from-black/80 to-transparent p-8">
        <div className="text-center">
          <Button 
            ...
            variant="ghost" 
            className="text-green-400/80 hover:text-green-400 hover:bg-green-400/10 hover:shadow-[0_0_15px_rgba(34,197,94,0.3)] transition-all duration-300 border border-green-400/20"
          >
            Browse Market Demo
          </Button>
        </div>
