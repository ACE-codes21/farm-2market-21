          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="mb-4">
              <h2 className="text-2xl md:text-4xl font-black text-white leading-tight tracking-wide">
                <span className="bg-gradient-to-r from-white via-green-200 to-white bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(255,255,255,0.8)] animate-pulse text-7xl">Fresh from the</span>
              </h2>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-6 pt-16">
              ...
              return <div key={index} className={`group flex items-center gap-3 px-6 py-4 bg-gradient-to-r ${colorClasses[feature.color as keyof typeof colorClasses]} backdrop-blur-sm border rounded-2xl hover:scale-110 transition-all duration-500 cursor-pointer shadow-lg hover:shadow-2xl`} style={{
                animationDelay: `${1.2 + index * 0.15}s`
              }}>
                    <IconComponent className="h-5 w-5 group-hover:rotate-12 transition-transform duration-300" />
                    <span className="font-medium group-hover:font-semibold transition-all duration-300">{feature.text}</span>
