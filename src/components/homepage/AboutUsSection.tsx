    ...
    <section ref={sectionRef} id="about-us" className="relative py-24 px-4 bg-gradient-to-b from-neutral-950/95 via-black/90 to-black">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <motion.p
          ...
          Our vision centers around <span className="text-cyan-300">enabling financial inclusion</span>, smart tools, and direct relationships between <span className="text-green-400">producers and consumers</span>.<br />
