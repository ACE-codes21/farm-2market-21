      ...
      <div className="space-y-3">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            <Label htmlFor="vendorName" className="text-slate-300 text-sm">Business/Vendor Name</Label>
            <Tooltip>
              <TooltipTrigger>
          ...
          />
          {errors.vendor_name && <p className="text-red-400 text-xs">{errors.vendor_name}</p>}
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Label htmlFor="aadharNumber" className="text-slate-300 text-sm">Aadhar Number</Label>
              <Tooltip>
                <TooltipTrigger>
                  <Info className="h-3 w-3 text-slate-400" />
                </TooltipTrigger>
            ...
            <Input
              ...
              maxLength={12}
            />
            {errors.aadhar_number && <p className="text-red-400 text-xs">{errors.aadhar_number}</p>}
          </div>

          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <Label htmlFor="panNumber" className="text-slate-300 text-sm">PAN Number</Label>
              <Tooltip>
                <TooltipTrigger>
                  <Info className="h-3 w-3 text-slate-400" />
                </TooltipTrigger>
            ...
            <Input
              ...
              maxLength={10}
            />
            {errors.pan_number && <p className="text-red-400 text-xs">{errors.pan_number}</p>}
          </div>
        </div>
