  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 animate-fade-in" style={{animationDelay: '0.3s'}}>
      <div className="space-y-2">
        <Label htmlFor="signup-name" className="text-xs font-medium text-gray-300">Full Name</Label>
        <div className="relative">
          <User className="absolute left-2.5 top-1/2 transform -translate-y-1/2 h-3.5 w-3.5 text-green-400/60" />
          <Input
            id="signup-name"
            type="text"
      ...
      <div className="space-y-2">
        <Label htmlFor="signup-email" className="text-xs font-medium text-gray-300">Email</Label>
        <div className="relative">
      ...
      <div className="space-y-2">
        <Label htmlFor="signup-password" className="text-xs font-medium text-gray-300">Password</Label>
        <div className="relative">
