    ...
    <div className="min-h-screen bg-slate-900 text-gray-200">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
        <div className="mb-8 animate-fade-in-up">
          <h2 className="text-3xl font-bold font-display gradient-text mb-2">Finance Hub</h2>
          <p className="text-slate-400">Your financial health at a glance. Access credit, track loans, and grow your business.</p>
        </div>
